...
LENGTH_HASH = os.environ.get("HASHER_SALT_LENGTH_BYTES", 32)
COUNT_HASH_ITER = os.environ.get("HASHER_COUNT_ITER", 100_000)

# Шифрование
SALT_LENGTH_BYTES = os.environ.get("CRYPTO_SALT_LENGTH_BYTES", 16)
