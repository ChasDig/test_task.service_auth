    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uri_name', models.CharField(help_text='Наименование ресурса', max_length=256)),
                ('comment', models.CharField(help_text='Комментарий к выделению права для группы (может использоваться для объяснения причины и т.д.)', max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Время обновления сущности')),
                ('deleted_at', models.DateTimeField(default=None, help_text='Время удаления сущности (мягкое удаление)', null=True)),
                ('permission_by_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_permission_by_group', to='api_auth.permissionbygroup')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_permission_by_group', to='api_auth.user')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='permissionbygroup',
            constraint=models.UniqueConstraint(condition=models.Q(('deleted_at__isnull', True)), fields=('uri', 'group'), name='group_permission_unique', violation_error_message='У группы имеется доступ к ресурсу'),
        ),
        migrations.AddConstraint(
            model_name='userpermissionbygroupassociation',
            constraint=models.UniqueConstraint(condition=models.Q(('deleted_at__isnull', True)), fields=('user', 'permission_by_group'), name='unique_user_group_permission', violation_error_message='Пользователю уже выданы указанные права'),
        ),
    ]
