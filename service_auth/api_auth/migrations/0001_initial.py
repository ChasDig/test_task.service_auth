    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_auth.group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Время обновления сущности')),
                ('deleted_at', models.DateTimeField(default=None, help_text='Время удаления сущности (мягкое удаление)', null=True)),
                ('permission_by_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_auth.permissionbygroup')),
